...
export class Main {
	...
	public static watch(): vscode.Disposable {
		...
		const filePath = path.join(env.appRoot, "out", 'vs', 'code', 'electron-sandbox', 'workbench', 'workbench.js');  //const filePath = path.join(base, 'vs', 'code', 'electron-sandbox', 'workbench', 'workbench.js');
